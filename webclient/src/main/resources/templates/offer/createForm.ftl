...
<div class="container">
    ...
    <form name="offer" class="form-horizontal" action="/offers/save" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="description"  placeholder="Введите краткое описание">
        </div>
        <div class="form-group">
            <label for="fullDescription">Полное описание</label>
            <textarea class="form-control" name="fullDescription"  placeholder="Введите описание"></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="imageUrl"  placeholder="Введите url фото">
        </div>
        <div class="form-group">
