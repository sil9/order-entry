...
public class DatabaseQuery {
    ...
    public static final String FIND_OFFERS_BY_TAG = "SELECT o FROM Offer o" +
                                                    "INNER JOIN o.tags t" +
                                                    "WHERE t = :tag";
    public static final String FIND_AVAILABLE_OFFERS = "SELECT o FROM Offer o WHERE o.availability = true ";
